      ...
      var TagCloud = function() {
        ...
        _createClass(TagCloud2, [{
          ...
          value: function _computePosition(index2) {
            ...
            if (random) index2 = Math.floor(Math.random() * (textsLength + 1));
          ...
          value: function _requestInterval(fn, delay) {
            ...
            function loop() {
              ...
              var current = (/* @__PURE__ */ new Date()).getTime(), delta = current - start;
              if (delta >= delay) {
                fn.call();
          ...
          value: function _next() {
            ...
            if (self2.config.reverseDirection) {
              a = -a;
              b = -b;
            }
          ...
          value: function destroy() {
            ...
            if (index2 !== -1) TagCloud2.list.splice(index2, 1);
...
export default require_TagCloud();
/*! Bundled license information:

TagCloud/dist/TagCloud.js:
  (*!
   * TagCloud.js v2.5.0
