    ...
    <section id="contact" className="w-full max-w-4xl mx-auto py-32 px-6 text-center">
      ...
      >
        ...
        <motion.a
          ...
          target="_blank"
          className="w-14 h-14 flex items-center justify-center rounded-full bg-white/10
                     text-white shadow-lg hover:bg-secondary hover:text-primary transition-all"
